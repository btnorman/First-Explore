...
from config import args_easy_world_rl2, args_hard_world_rl2
from config import args_easy_world_varibad, args_hard_world_varibad
from config import args_2_treasure_rl2, args_3_treasure_rl2
from config import args_2_treasure_varibad, args_3_treasure_varibad
...
def main():
    ...
    if env == 'easy_world_rl2':
        args = args_easy_world_rl2.get_args(rest_args)
    elif env == 'hard_world_rl2':
        args = args_hard_world_rl2.get_args(rest_args)
    elif env == 'easy_world_vb':
        args = args_easy_world_varibad.get_args(rest_args)
    elif env == 'hard_world_vb':
        args = args_hard_world_varibad.get_args(rest_args)
    
    
    # --- First-Explore Treasure Rooms ---
    
    if env == 'treasure_easy_varibad':
        args = args_easy_treasure_varibad.get_args(rest_args)
    elif env == 'treasure_medi_varibad':
        args = args_medi_treasure_varibad.get_args(rest_args)
    elif env == 'treasure_hard_varibad':
        args = args_hard_treasure_varibad.get_args(rest_args)
        
    elif env == 'treasure_easy_rl2':
        args = args_easy_treasure_rl2.get_args(rest_args)
    elif env == 'treasure_medi_rl2':
        args = args_medi_treasure_rl2.get_args(rest_args)
    elif env == 'treasure_hard_rl2':
        args = args_hard_treasure_rl2.get_args(rest_args)
        
        
    # --- First-Explore Stochastic-Bandit ---
    elif env == 'bandit_rl2' or env == 'mean_bandit_rl2' or env == 'control_bandit_rl2':
